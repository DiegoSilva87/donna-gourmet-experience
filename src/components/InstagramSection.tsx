      ...
      <div ref={ref} className="container mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 grid grid-cols-2 gap-3 md:grid-cols-3">
          {images.map((img, i) => (
            <motion.a
              key={i}
              href="https://instagram.com/donna_emporio_gourmet"
              target="_blank"
        ...
        <div className="mt-10 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 font-body text-xs font-semibold uppercase tracking-[0.2em] text-gold transition-colors hover:text-foreground"
          >
